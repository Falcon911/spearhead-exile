...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_MOHAWK = ["Exile_Chopper_Mohawk_FIA"]; //With Chopper ["Exile_Chopper_Mohawk_FIA"];
	IL_Supported_Vehicles_CHINOOK = ["Exile_Chopper_Huron_Black", "Exile_Chopper_Huron_Green"]; //With Chopper ["Exile_Chopper_Huron_Black", "Exile_Chopper_Huron_Green"]
