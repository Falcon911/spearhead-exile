	...
	class   hlc_5rnd_300WM_mk248_AWM                { quality = 1; price = 100;};
	class   hlc_5rnd_300WM_FMJ_AWM                  { quality = 1; price = 100;};
	...
	class   hlc_rifle_m14sopmod						{ quality = 1; price = 650; };
	...
	class 	hlc_rifle_awcovert						{ quality = 1 ;price = 1400;};