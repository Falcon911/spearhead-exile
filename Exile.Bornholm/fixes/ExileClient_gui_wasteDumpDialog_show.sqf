...
_nearVehicles = nearestObjects [player, ["Car", "Bike", "Motorcycle", "Plane", "Air", "Ship", "Tank"], 150];
_localVehicles = [];
{
	if (local _x) then
	{
...
_revenue ctrlSetStructuredText (parseText "<t size='1.4'>0<img image='\exile_client\texture\ui\poptab_notification_ca.paa' size='1' shadow='true' /></t>");
