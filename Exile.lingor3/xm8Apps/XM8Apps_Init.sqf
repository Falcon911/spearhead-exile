...
//App 5
_app5Text = "Info";
_app5Logo = "\exile_assets\texture\ui\xm8_app_cosa_nostra_ca.paa";
app5_action = {
...
_app6Logo = "xm8Apps\Apps\Player scan\radarLogo.paa";
app6_action = {
  execVM "xm8Apps\Apps\Player scan\playerScan.sqf";
};

//App 7
_app7Text = "Player Stats";
_app7Logo = "xm8Apps\Apps\Player Stats\Stats_IconWhite.paa";
app7_action = {
  execVM"xm8Apps\Apps\Player Stats\PlayerStats.sqf";
};

//App 8
_app8Text = "Base Locator";
_app8Logo = "\exile_assets\texture\ui\snap_blue_ca.paa";
app8_action = {
	private ["_position"];
...
//App 9
_app9Text = "Info";
_app9Logo = "xm8Apps\Apps\eBase\images\EBase.paa";
app9_action = {
  execVM "xm8Apps\Apps\eBase\Scripts\eBase.sqf";
};
